    ...
    class InventoryMenuItemWorkUI : InventoryMenuItemUI
    {
        ...
        public static void InventoryMenuItemWorkDisplay(InputHandler inputHandler, CharacterSelectionUI characterUI)
        {
            ...
            while (conti)
            {
                ...
                InventoryMenuItemBoxHandler.GameMenuFourthdDisplay(inputHandler, characterUI);
                InventoryMenuItemWorkBoxHandler.GameMenuThirdDisplay(inputHandler, characterUI);
